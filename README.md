...
1. clone this repo: `git clone git@github.com/Alex-0407/sinacloud-node.git`
2. `cd sinacloud-node`
3. `npm install`
...
### 项目地址：
https://github.com/Alex-0407/sinacloud-node
...
为了保证连接的可使用性，请关注微信公众号<font color=red size=10 face="黑体">全栈弄潮儿</font>，
...
#### 欢迎关注我的微信公众号 <font color=red size=10 face="黑体">全栈弄潮儿</font> ，获取更多学习资源
